...
see [Skycoin REST API Client Godoc](https://godoc.org/github.com/ness-network/privateness/src/api#Client).
...
See [`coin.Transaction.Serialize`](https://godoc.org/github.com/ness-network/privateness/src/coin#Transaction.Serialize).
