...
Read more about API sets here: https://github.com/ness-network/privateness/blob/develop/src/api/README.md#api-sets
...
Read more about `pprof`: https://github.com/ness-network/privateness/wiki/Profiling-with-pprof
...
The size of a transaction is the length of its byte representation in the [Skycoin binary encoding format](https://github.com/ness-network/privateness/wiki/Skycoin-Binary-Encoding-Format).
