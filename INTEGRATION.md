...
* [Skycoin REST API Client Godoc](https://godoc.org/github.com/ness-network/privateness/src/api#Client)
* [Skycoin CLI Godoc](https://godoc.org/github.com/ness-network/privateness/src/cli)
...
[Skycoin REST API Client](https://godoc.org/github.com/ness-network/privateness/src/api#Client)
...
We recommend using the [Skycoin REST API Client](https://godoc.org/github.com/ness-network/privateness/src/api#Client).
...
Create a transaction with [POST /wallet/transaction](https://github.com/ness-network/privateness/blob/develop/src/api/README.md#create-transaction),
then inject it to the network with [POST /injectTransaction](https://github.com/ness-network/privateness/blob/develop/src/api/README.md#inject-raw-transaction).
...
directly, see [Skycoin CLI Godoc](https://godoc.org/github.com/ness-network/privateness/src/cli).

A REST API client is also available: [Skycoin REST API Client Godoc](https://godoc.org/github.com/ness-network/privateness/src/api#Client).
...
See the [POST /wallet/transaction](https://github.com/ness-network/privateness/blob/develop/src/api/README.md#create-transaction)
...
https://godoc.org/github.com/ness-network/privateness/src/cipher#DecodeBase58Address
...
Use the [Skycoin REST API Client](https://godoc.org/github.com/ness-network/privateness/src/api#Client)
...
Use the [Skycoin CLI package](https://godoc.org/github.com/ness-network/privateness/src/cli)
